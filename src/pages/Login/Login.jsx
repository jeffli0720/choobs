...
function Login(props) {
	...
	const handleEmailAutofill = (e) => {
		if (e.target.value.match(/(\d{2})stu(\d{3})/) && !e.target.value.includes("@")) {
		...
		<>
			<div className={styles.loginPage}>
						...
						<>
							<form>
								...
								<div className={styles.toggleLoginSignup}>
									<p>Need an account?</p>
									<button className={styles.link} onClick={toggleLoginSignup} type="button">
										Register
									</button>
								</div>
							</form>
							{errorMessage && (
								<div className={`${styles.errorPopup} ${styles.errorAppear}`}>
				...
				<div className={styles.wave}>
					<svg id="visual" viewBox="0 0 2000 400" width="2000" height="400" xmlns="http://www.w3.org/2000/svg" version="1.1">
						<path
